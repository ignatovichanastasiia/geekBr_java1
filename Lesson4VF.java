...
public class Lesson4VF {
    ...
    public static char[] WIN_GAMER = new char[]{DOT_X, DOT_X, DOT_X, DOT_X};
    public static char[] WIN_AI = new char[]{DOT_O, DOT_O, DOT_O, DOT_O};
    public static char[] BEFORE_WIN = new char[]{DOT_X, DOT_X, DOT_X, DOT_EMPTY};
